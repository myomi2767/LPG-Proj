      ...
      <div class="recentitems portfolio" data-animate="fadeIn">
        ...
        <div class="graphic-design" >
          <div class="he-wrap tpl6">
            <img src="img/portfolio/portfolio_09.jpg" alt="ÆÀ¾Úºí·³" class="myimg">
            <img src="img/portfolio/versus.jpg" alt="" class="myimg">
            <img src="img/portfolio/portfolio_03.jpg" alt="ÆÀ¾Úºí·³" class="myimg">
            <div class="he-view" >	
              <div class="bg a0">
              	<h3 class="a1" data-animate="fadeInDown" style="word-spacing: 350px">HOME VS AWAY</h3>
                <h4 class="a1" data-animate="fadeInDown" style="word-spacing: 735px">ÆÀ¸í ÆÀ¸í</h4>
              </div>
              <!-- he bg -->
            </div>
            <!-- he view -->
